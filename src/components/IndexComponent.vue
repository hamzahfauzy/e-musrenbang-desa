			...
			<div class="logo">
				...
				<div class="container z-mobile">
					<div class="row">
						...
						<a href="http://eplanning.asahankab.go.id/panduan/USER%20MANUAL%20APLIKASI%20EMUSRENBANG%20DESA.pdf" class="btn me-btn col-sm-12 col-md-4">Panduan</a>
...
export default {
	...
	methods: {
		...
		async cetakBeritaAcara(){
			var vm = this
			let response = await fetch(window.config.getApiUrl()+'api/save-berita-acara-desa&token='+this.token,{
				method:'POST',
